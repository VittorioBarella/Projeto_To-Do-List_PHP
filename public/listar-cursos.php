<!-- Buscar os cursos no banco de dados e exibe eles na tela. -->
<?php
require __DIR__ . '/../vendor/autoload.php';

// Entity Manager é a classe do doctrine responsável por gerenciar o estado das entidades e realizar as escritas
// no banco de dados.
